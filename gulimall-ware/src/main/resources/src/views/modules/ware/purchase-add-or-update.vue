<template>
  <el-dialog
    ...
    <el-form-item label="?ɹ???id" prop="assigneeId">
      <el-input v-model="dataForm.assigneeId" placeholder="?ɹ???id"></el-input>
    </el-form-item>
    <el-form-item label="?ɹ?????" prop="assigneeName">
      <el-input v-model="dataForm.assigneeName" placeholder="?ɹ?????"></el-input>
    </el-form-item>
    <el-form-item label="??ϵ??ʽ" prop="phone">
      <el-input v-model="dataForm.phone" placeholder="??ϵ??ʽ"></el-input>
    </el-form-item>
    <el-form-item label="???ȼ?" prop="priority">
      <el-input v-model="dataForm.priority" placeholder="???ȼ?"></el-input>
    </el-form-item>
    ...
    <el-form-item label="?ܽ" prop="amount">
      <el-input v-model="dataForm.amount" placeholder="?ܽ"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        },
        {
          ...
          phone: [
            { required: true, message: '??ϵ??ʽ不能为空', trigger: 'blur' }
          ],
          priority: [
          ...
          amount: [
            { required: true, message: '?ܽ不能为空', trigger: 'blur' }
          ],
          createTime: [
