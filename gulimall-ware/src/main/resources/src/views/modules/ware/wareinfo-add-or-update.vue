<template>
  <el-dialog
    ...
    <el-form-item label="?ֿ???" prop="name">
      <el-input v-model="dataForm.name" placeholder="?ֿ???"></el-input>
    </el-form-item>
    <el-form-item label="?ֿ???ַ" prop="address">
      <el-input v-model="dataForm.address" placeholder="?ֿ???ַ"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        {
          name: [
            { required: true, message: '?ֿ???不能为空', trigger: 'blur' }
          ],
          address: [
            { required: true, message: '?ֿ???ַ不能为空', trigger: 'blur' }
          ],
          areacode: [
